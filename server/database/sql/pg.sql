...
DROP TABLE IF EXISTS "public"."merchant_payment_configs";
...
;
ALTER TABLE "merchant_payment_configs" OWNER TO "postgres";
...
COMMIT;
BEGIN;
LOCK TABLE "public"."merchant_payment_configs" IN SHARE MODE;
DELETE FROM "public"."merchant_payment_configs";
COMMIT;
BEGIN;
...
ALTER TABLE "merchant_payment_configs" ADD CONSTRAINT "merchant_payment_configs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE "business_payments" ADD CONSTRAINT "business_payments_merchant_config_id_merchant_payment_configs_i" FOREIGN KEY ("merchant_config_id") REFERENCES "public"."merchant_payment_configs" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE "merchant_payment_configs" ADD CONSTRAINT "merchant_payment_configs_merchant_id_business_merchant_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."business_merchant" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
SELECT setval('"business_merchant_id_seq"', 5, true);
...
SELECT setval('"business_orders_id_seq"', 1, false);
...
OWNED BY "merchant_payment_configs"."id";
SELECT setval('"merchant_payment_configs_id_seq"', 1, false);
...
SELECT setval('"system_api_api_id_seq"', 321, true);
...
SELECT setval('"system_dict_data_dict_code_seq"', 28, true);
...
SELECT setval('"system_dict_type_dict_id_seq"', 9, true);
