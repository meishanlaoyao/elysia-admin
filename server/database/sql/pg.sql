...
Backup Time: 2026-03-31 17:32:33
*/
...
INSERT INTO "public"."business_orders" ("id","order_no","user_id","merchant_id","title","description","amount","currency","status","expire_at","payment_method","extra","create_time","create_by","update_time","update_by","del_flag","remark") VALUES (9, '019d4324d5527000b42d4da9aead6bdf', 1, 6, 'DR钻戒', '一生只送一人', 100.12, 'CNY', '0', NULL, 'alipay', '{"productId": 1, "productNum": 1, "productName": "DR钻戒", "productPrice": 100.12, "productTotal": 100.12}', '2026-03-31 09:06:20.629878+00', 1, NULL, NULL, 'f', NULL)
;
COMMIT;
BEGIN;
...
SELECT setval('"business_orders_id_seq"', 9, true);
...
SELECT setval('"system_api_api_id_seq"', 327, true);
...
SELECT setval('"system_menu_btn_btn_id_seq"', 57, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 272, true);
