...
Backup Time: 2026-02-05 16:48:36
*/
...
INSERT INTO "public"."system_user_role" ("role_id","user_id") VALUES (1, 1),(2, 1),(3, 1),(3, 20),(2, 20),(2, 14),(3, 14)
;
COMMIT;
...
SELECT setval('"system_api_api_id_seq"', 211, true);
...
SELECT setval('"system_login_log_log_id_seq"', 81, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 11, true);
