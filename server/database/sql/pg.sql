...
Backup Time: 2026-06-10 16:08:14
*/
...
SELECT setval('"system_api_api_id_seq"', 547, true);
...
SELECT setval('"system_login_log_log_id_seq"', 226, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 381, true);
