...
Backup Time: 2026-02-12 17:18:16
*/
...
INSERT INTO "public"."system_oper_log" ("oper_id","title","request_method","operator_type","user_id","oper_url","oper_ip","oper_location","oper_param","json_result","cost_time","status","create_time","create_by","update_time","update_by","del_flag","remark","action") VALUES (168, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"MinIO","region":null,"endpoint":null,"bucket":null,"accessKey":null,"secretKey":null,"status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"minio","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 24, 't', '2026-02-12 06:13:22.12058+00', NULL, NULL, NULL, 'f', NULL, '更新'),(169, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"rustfs","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 65, 't', '2026-02-12 08:00:53.912851+00', NULL, NULL, NULL, 'f', NULL, '更新'),(170, '存储配置', '3', NULL, NULL, '/api/system/storage', NULL, NULL, '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"http://192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"rustfs","createTime":"2026-02-11T09:01:32.285Z","updateTime":null}}', '', 54, 'f', '2026-02-12 08:07:34.507642+00', NULL, NULL, NULL, 'f', NULL, '更新'),(171, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"http://192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"rustfs","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 20, 't', '2026-02-12 08:07:48.503716+00', NULL, NULL, NULL, 'f', NULL, '更新'),(172, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"rustfs","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 43, 't', '2026-02-12 08:13:03.013612+00', NULL, NULL, NULL, 'f', NULL, '更新'),(173, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"该方案为本地文件服务，使用RustFS。前端拿到预签名url，需要在Header中传递Content-Type值，否则文件会直接下载无法预览。","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 67, 't', '2026-02-12 09:12:42.101404+00', NULL, NULL, NULL, 'f', NULL, '更新'),(174, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"该方案为本地文件服务，使用RustFS。前端拿到预签名url，需要在Header中传递Content-Type值，否则文件会直接下载无法预览。","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 16, 't', '2026-02-12 09:13:06.065023+00', NULL, NULL, NULL, 'f', NULL, '更新'),(175, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":2,"name":"COS","region":"ap-shanghai","endpoint":"","bucket":"","accessKey":"","secretKey":"","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"腾讯云","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 13, 't', '2026-02-12 09:13:19.50246+00', NULL, NULL, NULL, 'f', NULL, '更新'),(176, '存储配置', '3', 'admin', 1, '/api/system/storage', '::1', '内网地址', '{"body":{"storageId":1,"name":"RustFS","region":"us-east-1","endpoint":"192.168.2.22:9000","bucket":"public","accessKey":"rustfsadmin","secretKey":"rustfsadmin","status":true,"createBy":null,"updateBy":null,"delFlag":false,"remark":"该方案为本地文件服务，使用RustFS。前端拿到预签名url，需要在Header中传递Content-Type值，否则文件会直接下载无法预览。","createTime":{},"updateTime":null}}', '{"code":200,"msg":"操作成功","data":null}', 8, 't', '2026-02-12 09:13:20.30487+00', NULL, NULL, NULL, 'f', NULL, '更新')
;
COMMIT;
BEGIN;
...
INSERT INTO "public"."system_role_menu" ("role_id","menu_id","menu_btn_id") VALUES (1, 1, NULL),(1, 2, NULL),(1, 3, NULL),(1, 4, NULL),(1, 4, 25),(1, 4, 26),(1, 4, 27),(1, 4, 28),(1, 6, NULL),(1, 5, NULL),(1, 5, 29),(1, 5, 30),(1, 5, 31),(1, 5, 32),(1, 7, NULL),(1, 7, 2),(1, 7, 3),(1, 7, 5),(1, 7, 1),(1, 8, NULL),(1, 8, 9),(1, 8, 10),(1, 8, 11),(1, 8, 12),(1, 9, NULL),(1, 9, 17),(1, 9, 18),(1, 9, 19),(1, 9, 20),(1, 9, 21),(1, 9, 22),(1, 9, 23),(1, 9, 24),(1, 10, NULL),(1, 10, 14),(1, 10, 15),(1, 10, 16),(2, 1, NULL),(2, 2, NULL),(1, 10, 13),(1, 18, NULL),(1, 18, 33),(1, 18, 34),(1, 18, 35),(1, 18, 36),(1, 27, NULL),(1, 27, 47),(1, 27, 48),(1, 27, 49),(1, 27, 50),(1, 19, NULL),(1, 20, NULL),(1, 20, 37),(1, 20, 38),(1, 21, NULL),(1, 21, 39),(1, 21, 40),(1, 22, NULL),(1, 23, NULL),(1, 23, 41),(1, 23, 42),(1, 24, NULL),(1, 24, 43),(1, 24, 44),(1, 24, 45),(1, 24, 46),(1, 26, NULL)
;
COMMIT;
BEGIN;
...
SELECT setval('"system_api_api_id_seq"', 229, true);
...
SELECT setval('"system_login_log_log_id_seq"', 146, true);
...
SELECT setval('"system_menu_btn_btn_id_seq"', 50, true);
...
SELECT setval('"system_menu_menu_id_seq"', 27, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 176, true);
