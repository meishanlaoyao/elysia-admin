...
Backup Time: 2026-02-06 17:32:08
*/
...
SELECT setval('"system_login_log_log_id_seq"', 98, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 39, true);
