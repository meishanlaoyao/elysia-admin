...
Backup Time: 2026-06-16 10:02:49
*/
...
SELECT setval('"system_api_api_id_seq"', 658, true);
...
SELECT setval('"system_login_log_log_id_seq"', 228, true);
...
SELECT setval('"system_menu_menu_id_seq"', 39, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 393, true);
