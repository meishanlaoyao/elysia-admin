...
Backup Time: 2026-03-03 13:36:29
*/
...
INSERT INTO "public"."monitor_job" ("job_id","job_name","job_cron","status","create_time","create_by","update_time","update_by","del_flag","remark","job_args") VALUES (8, '测试任务', '0 * * * * *', 't', '2026-02-10 02:17:20.145+00', NULL, '2026-02-12 09:37:46.577+00', NULL, 'f', '', '["乔治",19,true]')
;
COMMIT;
BEGIN;
...
SELECT setval('"system_api_api_id_seq"', 239, true);
...
SELECT setval('"system_login_log_log_id_seq"', 172, true);
...
SELECT setval('"system_menu_btn_btn_id_seq"', 53, true);
...
SELECT setval('"system_menu_menu_id_seq"', 28, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 196, true);
