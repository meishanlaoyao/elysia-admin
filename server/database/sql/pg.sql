...
Backup Time: 2026-09-17 14:37:54
*/
...
DROP SEQUENCE IF EXISTS "public"."system_notice_notice_id_seq";
...
START 1
CACHE 1;
CREATE SEQUENCE "system_notice_notice_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
CREATE TABLE "system_notice" (
  "notice_id" int8 NOT NULL DEFAULT nextval('system_notice_notice_id_seq'::regclass),
  "title" varchar(128) COLLATE "pg_catalog"."default" NOT NULL,
  "notice_type" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
...
;
ALTER TABLE "system_notice" OWNER TO "postgres";
...
ALTER TABLE "system_notice" ADD CONSTRAINT "system_notice_pkey" PRIMARY KEY ("notice_id");
...
SELECT setval('"system_api_api_id_seq"', 659, true);
...
SELECT setval('"system_login_log_log_id_seq"', 233, true);
...
SELECT setval('"system_menu_btn_btn_id_seq"', 70, true);
...
SELECT setval('"system_menu_menu_id_seq"', 41, true);
ALTER SEQUENCE "system_menu_menu_id_seq" OWNER TO "postgres";
ALTER SEQUENCE "system_notice_notice_id_seq"
OWNED BY "system_notice"."notice_id";
SELECT setval('"system_notice_notice_id_seq"', 1, true);
ALTER SEQUENCE "system_notice_notice_id_seq" OWNER TO "postgres";
ALTER SEQUENCE "system_oper_log_oper_id_seq"
OWNED BY "system_oper_log"."oper_id";
SELECT setval('"system_oper_log_oper_id_seq"', 409, true);
