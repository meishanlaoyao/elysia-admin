...
Backup Time: 2026-03-21 17:18:14
*/
...
DROP TABLE IF EXISTS "public"."wxmp_user";
...
CREATE TABLE "system_login_log" (
  ...
  "del_flag" bool DEFAULT false,
  "remark" varchar(255) COLLATE "pg_catalog"."default",
  "login_user_id" varchar(64) COLLATE "pg_catalog"."default"
)
;
...
COMMIT;
BEGIN;
LOCK TABLE "public"."wxmp_user" IN SHARE MODE;
DELETE FROM "public"."wxmp_user";
COMMIT;
...
ALTER TABLE "wxmp_user" ADD CONSTRAINT "wxmp_user_pkey" PRIMARY KEY ("user_id");
...
ALTER TABLE "wxmp_user" ADD CONSTRAINT "wxmp_user_open_id_unique" UNIQUE ("open_id");
...
SELECT setval('"system_api_api_id_seq"', 248, true);
...
SELECT setval('"system_login_log_log_id_seq"', 184, true);
...
SELECT setval('"system_menu_btn_btn_id_seq"', 56, true);
...
SELECT setval('"system_menu_menu_id_seq"', 30, true);
...
SELECT setval('"system_oper_log_oper_id_seq"', 212, true);
