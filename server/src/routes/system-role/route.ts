...
const SystemRoleModule: IRouteModule = {
    tags: '系统角色',
    routes: [
        { url: '/system/role', method: 'post', summary: '创建', dto: CreateDto, handle: create, meta: { isAuth: true, permission: 'system:role:create' } },
        ...
        { url: '/system/role', method: 'put', summary: '更新', dto: UpdateDto, handle: update, meta: { isAuth: true, permission: 'system:role:update' } },
        { url: '/system/role/permission', method: 'put', summary: '更新角色权限', dto: UpdatePermissionDto, handle: updatePermission, meta: { isAuth: true, permission: 'system:role:update' } },
        { url: '/system/role/:ids', method: 'delete', summary: '删除', handle: remove, meta: { isAuth: true, permission: 'system:role:delete' } },
    ]
};
