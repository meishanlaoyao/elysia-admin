...
const SystemRoleModule: IRouteModule = {
    ...
    routes: [
        ...
        { url: '/system/role/list', method: 'get', summary: '查询列表', dto: ListDto, handle: findList, meta: { isAuth: true, isLog: true, permission: 'system:role:query' } },
        { url: '/system/role/options', method: 'get', summary: '下拉选项数据', handle: findOptions, meta: { isAuth: true, permission: 'system:role:query' } },
        { url: '/system/role/permission/:id', method: 'get', summary: '查询角色权限', handle: findOnePermission, meta: { isAuth: true, isLog: true, permission: 'system:role:query' } },
        { url: '/system/role/:id', method: 'get', summary: '查询详情', handle: findOne, meta: { isAuth: true, isLog: true, permission: 'system:role:query' } },
