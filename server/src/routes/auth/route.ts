...
const AuthModule: IRouteModule = {
    ...
    routes: [
        ...
        { url: '/auth/refresh', method: 'post', summary: '刷新令牌', handle: refreshToken, },
        { url: '/auth/register', method: 'post', summary: '注册用户', dto: RegisterUserDto, handle: registerUser, },
        { url: '/auth/forget', method: 'post', summary: '忘记密码', dto: ForgetPasswordDto, handle: forgetPassword, },
        { url: '/auth/reset-password', method: 'post', summary: '重置密码', dto: ResetPasswordDto, handle: resetPassword, },
    ]
};
