...
import { accountPasswordLogin, refreshToken, wxmpPhoneLogin, registerUser, forgetPassword, resetPassword } from "./handle";
...
const AuthModule: IRouteModule = {
    ...
    routes: [
        ...
        { url: '/auth/login/wxmp-phone', method: 'post', summary: '手机号组件登陆', dto: WxmpPhoneLoginDto, handle: wxmpPhoneLogin, meta: { ipRateLimit: '120:3', } },
