...
- Read [`.ai/AI_PHASED_TASKS.md`](.ai/AI_PHASED_TASKS.md); write under `.qoder/feature-tasks/{slug}/` (`CHECKLIST.md` + `NN-*.md`)
...
- `server/database/sql/pg.sql` (**NEVER read or modify** — backup snapshot only)
